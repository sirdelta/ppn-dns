    ...
    //------------------------end initialisation-------------------------------------------------------------------------------------------------------
          ...
          int h_set(hkey_t key, val_t val) {
           ...
           // int indix = 0;
            ...
            if(table[indix].key == "vide") {
              table[indix].key = key;
              table[indix].val = val;
            }
            else if(tab1[indix].key == "vide") {
            ...
            else if(tab3[indix].key == "vide") {

              tab3[indix].key = key;
              tab3[indix].val = val;

            }
            else if(tab4[indix].key == "vide") {
